...
class BPrice extends StatefulWidget {
  const BPrice({Key? key}) : super(key: key);

  @override
  State<BPrice> createState() => _BPriceState();
}

class _BPriceState extends State<BPrice> {
  ...
  calculate() {
    ...
    result = Price.bPrice(p0: p0, i: i, n: n, t: t);
  }
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'O valor do saldo devedor a partir do mês escolhido é de:',
