...
class APrice extends StatefulWidget {
  const APrice({Key? key}) : super(key: key);

  @override
  State<APrice> createState() => _APriceState();
}

class _APriceState extends State<APrice> {
  ...
  calculate() {
    ...
    result = Price.aPrice(p0: p0, i: i, n: n);
  }
