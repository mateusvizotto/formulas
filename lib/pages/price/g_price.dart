...
class GPrice extends StatefulWidget {
  const GPrice({Key? key}) : super(key: key);

  @override
  State<GPrice> createState() => _GPriceState();
}

class _GPriceState extends State<GPrice> {
  ...
  calculate() {
    ...
    result = Price.gPrice(p0: p0, i: i, n: n, t: t);
  }
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'O valor das amortizações acumuladas até o mês escolhido é de:',
