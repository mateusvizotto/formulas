...
class FPrice extends StatefulWidget {
  const FPrice({Key? key}) : super(key: key);

  @override
  State<FPrice> createState() => _FPriceState();
}

class _FPriceState extends State<FPrice> {
  ...
  calculate() {
    ...
    result = Price.fPrice(p0: p0, i: i, n: n, t: t);
  }
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'O valor da amortização no mês escolhido é de:',
