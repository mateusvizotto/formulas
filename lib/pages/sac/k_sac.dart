...
class KSac extends StatefulWidget {
  const KSac({Key? key}) : super(key: key);

  @override
  State<KSac> createState() => _KSacState();
}

class _KSacState extends State<KSac> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'O valor do decréscimo nas prestações é de:',
