...
class CSac extends StatefulWidget {
  const CSac({Key? key}) : super(key: key);

  @override
  State<CSac> createState() => _CSacState();
}

class _CSacState extends State<CSac> {
  ...
  calculate() {
    ...
    result = (totalEmprestado / qtdMeses) * (qtdMeses - qtdMesesPagos + 1);
  }
